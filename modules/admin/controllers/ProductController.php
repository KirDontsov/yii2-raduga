...
class ProductController extends Controller
{
    ...
    {
        $imaged = Image::find()->where(['id' => $id])->one();
        @unlink(Yii::getAlias('@webroot/uploads/') . $imaged->filePath);
        Yii::$app->session->setFlash('success', "Картинка {$id} удалена");
        $delItem = $imaged->itemId;
        $imaged->delete();
        return $this->redirect(['view','id'=>$delItem]);
    }
